...
export default function MakeAnImpact() {
  ...
  return (
    <div className="flex flex-col items-center md:justify-evenly justify-evenly w-screen h-screen  bg-gradient-to-t from-cyan-400 to-transparent pb-56 mt-8 py-2 ">
      <Text
        css={{
      ...
      <div className="flex flex-col md:flex-row md:justify-evenly max-h-full  justify-between bg-transparent items-center w-full h-full">
        <div className="relative mt-32 space-y-36">
          <div className="absolute shadow-lg  -mt-2.5  w-[310px] md:w-screen h-[580px] md:h-screen md:max-h-[850px]  rounded-lg bg-yellow-400 animate-pulse -z-10" />
          <div className="rounded-lg flex flex-col  w-[280px] md:w-screen space-y-10  md:space-y-36 md: md:items-center   md:[750px] h-[550px]">
            <div className="rounded-lg -mt-32 w-[280px] h-[250px] ">
            ...
            <div className="w-full max-w-5xl rounded-lg overflow-visible z-30 ">
