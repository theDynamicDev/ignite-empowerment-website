    ...
    <div className="flex flex-col content w-full flex-wrap md:flex-row md:flex-wrap md:justify-evenly items-center  justify-center md:items-start -z-40 md:z-30 bottom-12 ">
      ...
      {images.map((image, index) => (
        <motion.div
          animate={controls}
          key={index}
          className={`relative w-full mt-10 max-w-[360px] lg:object-cover md:max-w-[220px] lg:max-w-[325px] xl:max-w-[250px] 2xl:max-w-xs lg:-mx-1  h-96 py-2 -my-24 xl:mx-[5px]  rounded-md overflow-hidden shadow-lg shadow-black/40  bottom-10  `}
        >
          <Image
            src={image.src}
            alt="Description"
