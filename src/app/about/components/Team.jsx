...
const Team = () => {
  ...
  const lisaV = '/public/images/Lisa-Vignola.png'
  return (
    <section className=" flex relative justify-center  top-10 md:top-32 items-center h-screen">
      <div className=" justify-center  items-center md:flex-row flex-col w-full h-full">
        ...
        <div className="h-[79vh] md:h-[570px] overflow-y-scroll overflow-x-scroll gap-y-[100%] grid-flow-row grid grid-cols-1 grid-rows-3 md:grid-rows-1 md:gap-x-44 md:grid-flow-col md:grid-cols-3  md:px-10 justify-center items-center bg-white">
